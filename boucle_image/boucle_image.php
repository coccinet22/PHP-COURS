...
<!DOCTYPE html>
    ...
    <body>
        ...
        <?php 
            for($i = 1; $i < 6; $i++) {
                echo '<img src="image' . $i . '.jpg" alt="une image blablabla"> ';
            }
        
        ?>
        <h2>Exercice autres façons</h2>
        <?php
        $arr = array('image1','image2', 'image3','image4','image5');
        ...
        <?php 
            ...
            for($i = 1; $i < 6; $i++) {
                echo "<img src='image$i.jpg' alt='une image$i'>";
            }
